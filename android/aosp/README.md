...
This directory is a source template. Run `tools/export-aosp-bundle.sh` to build
the ARM64 APK and daemon binaries and create a self-contained directory that can
be copied into an Android ROM source tree.
...
domain to reach its abstract control socket on production builds.
